...
export default function MapSection() {
  return (
    <div className="w-full max-w-[1400px] mx-auto mt-8 md:mt-10 px-4 sm:px-6 pb-10">
      <div className="bg-[#FFFFFF] rounded-xl pt-6 md:pt-10 w-full">
        
        <div className="mb-6 md:mb-9 pr-4 md:pr-10 border-b border-[#E5E7EB]">
          <button className="text-[#E53935] font-roboto font-medium text-lg border-b-2 border-[#E53935] pb-6 w-[130px]">
            Ош
          </button>
        </div>

        <div className="bg-[#F2F2F4] rounded-xl max-w-[1088px] w-full h-[300px] md:h-[384px] overflow-hidden mx-auto">
          <iframe
